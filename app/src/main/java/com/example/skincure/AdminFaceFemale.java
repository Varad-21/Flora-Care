...
public class AdminFaceFemale extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_face_female);
            ...
            databaseReference.child(postIdToUpdate).setValue(updatedPost)
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            Toast.makeText(AdminFaceFemale.this, "Post updated successfully", Toast.LENGTH_SHORT).show();
                        }
                    })
                    .addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(AdminFaceFemale.this, "Failed to update post: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
        ...
        if (!name.isEmpty()) {
            ...
            databaseReference.orderByChild("name").equalTo(name).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                        ...
                        databaseReference.child(postId).removeValue()
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    @Override
                                    public void onSuccess(Void aVoid) {
                                        Toast.makeText(AdminFaceFemale.this, "Post deleted successfully", Toast.LENGTH_SHORT).show();
                                    }
                                })
                                .addOnFailureListener(new OnFailureListener() {
                                    @Override
                                    public void onFailure(@NonNull Exception e) {
                                        Toast.makeText(AdminFaceFemale.this, "Failed to delete post: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                                    }
                                });
                    }
                }
                ...
                public void onCancelled(@NonNull DatabaseError databaseError) {
                    Toast.makeText(AdminFaceFemale.this, "Failed to delete post: " + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
        } else {
        ...
        if (imageUri != null && !name.isEmpty() && !prevention.isEmpty() && !precautions.isEmpty()) {
            ...
            databaseReference.child(postId).setValue(post)
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        @Override
                        public void onSuccess(Void aVoid) {
                            Toast.makeText(AdminFaceFemale.this, "Post added successfully", Toast.LENGTH_SHORT).show();
                        }
                    })
                    .addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(AdminFaceFemale.this, "Failed to add post: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
        } else {
