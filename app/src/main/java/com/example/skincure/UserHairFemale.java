...
public class UserHairFemale extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_hair_female);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("posts2");
