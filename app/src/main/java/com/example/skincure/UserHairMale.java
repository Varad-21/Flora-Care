...
public class UserHairMale extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_hair_male);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("posts3");
                ...
                new FirebaseRecyclerAdapter<Post, PostViewHolder>(options) {
                    ...
                    public PostViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                        ...
                        View view = LayoutInflater.from(parent.getContext())
                                .inflate(R.layout.post_item3, parent, false);
